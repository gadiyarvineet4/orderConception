...
class PersistOrderDB(object):
    ...
    def createOrderLineQuery(self):
        ...
        order_line_query="INSERT INTO order_line(order_header_key,order_line_key,order_number,ship_advice_no,item_type,item_id,item_name,quantity,item_line_no,delivery_line_no,price,sku,description,ship_node) VALUES (%s, %s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s, %s, %s)"
        return order_line_query

    def createWorkOrderQuery(self):
        work_order_query="INSERT INTO work_order(work_order_key,order_header_key,work_order_number,work_order_sgr,delivery_line_no,appointment_start_time,appointment_end_time) VALUES (%s, %s, %s, %s, %s, %s, %s)"
